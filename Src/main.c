...
int main(void)
{
  ...
  {
    /* USER CODE END WHILE */
	  HAL_GPIO_WritePin(GPIOB,ST1_Pin,1);
	  HAL_GPIO_WritePin(GPIOB,ST2_Pin,1);
	  if(HAL_GPIO_ReadPin(GPIOB,Sensor1_Pin) == 1){
		  HAL_GPIO_WritePin(GPIOA,EN1_Pin,0);
		  HAL_GPIO_WritePin(GPIOA,EN2_Pin,1);

	  }else if(HAL_GPIO_ReadPin(GPIOB,Sensor2_Pin) == 1){
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, ST2_Pin|ST1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : ST2_Pin ST1_Pin */
  GPIO_InitStruct.Pin = ST2_Pin|ST1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
